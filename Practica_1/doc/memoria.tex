...
\begin{document}
    ...
    El primero sta función está formada por cuatro operaciones elementales al inicio del código, de eficiencia $O(1)$, al tratarse de declaraciones y asignaciones, y un bucle while 
    cuyo contenido va iterando en torno a potencias de dos, pues k se va decrementando a la mitad en cada iteración.
