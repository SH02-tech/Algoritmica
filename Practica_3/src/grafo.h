...
public:
  ...
  bool operator<(const arco<Tn,Ta> & a) {
...
public:
  ...
  ////////////////////////////////////////////////
  // ADDED: Consultores para el grado del nodo
  ...
  int grado() {
      return getNArcosAdy() + getNArcosInc();
  }
...
public:
  ...
  nodo<Tn,Ta>* buscarNodoConIndice(int i);
...
template <typename Tn, typename Ta>
nodo<Tn,Ta> * grafo<Tn,Ta>::buscarNodoConIndice(int i){
  int k;
  nodoIterator it;
...
public:
  ...
  profundidadIterator(grafo<Tn,Ta>& G){
    ...
    iterador = G.buscarNodoConIndice(0);
