...
\begin{algorithm}[H]
  \caption{Algoritmo auxiliar para la inserción. CiudadEconomica}\label{alg:insercion-aux-2}
  ...
  $(c_a, c_{a+1}, var_a)$ = InsercionEconomica(ady,ciclo,ind)\;
  ...
  \For{i desde ind+1 hasta ady.tamaño}{
    \If{banderas[i] no activado}{
      ...
      \If{$var_n < var_a$ }{
        $(c_a, c_{a+1}, var_a)$ = $(c_{n}, c_{n+1}, var_n)$\;
      }
    }
  }
...
\begin{algorithm}[H]
    \caption{Algoritmo basado en inserción. CicloInsercionEconomica}\label{alg:insercion}
    \begin{minipage}{0.92\textwidth}
