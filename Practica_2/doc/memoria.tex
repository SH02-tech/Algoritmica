...
\begin{document}
    ...
    \input{cap/1-introduccion.tex}
    \newpage

    \section{Ejercicio 1: Vector de índice coincidente}
    \input{cap/2-ejercicio1.tex}
    \newpage
    
    \section{Ejercicio 2: Mezcla ordenada de vectores}
    \input{cap/3-ejercicio2.tex}
    \newpage

    \section{Conclusión}
    \input{cap/4-conclusion.tex}
